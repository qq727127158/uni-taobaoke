<template>
	<view class="uni-tab-bar">
		...
		<scroll-view id="tab-bar" class="uni-swiper-tab" scroll-x :scroll-left="scrollLeft">
			<view v-for="(tab, index) in tabs" :key="index" class="swiper-tab-list" :class="{ active: tabIndex == index }" :id="'tab_' + tab.id"
			 @click="tapTab(tab, index)">
				{{ tab.name }}
			</view>
		</scroll-view>
		...
		<swiper :current="tabIndex" class="swiper-box touch-action-none" skip-hidden-item-layout="true" :duration="300"
		 @change="changeTab">
			<swiper-item v-for="(good, index) in goods" :key="index">
				<scroll-view class="good-list touch-action-none" :scroll-top="scrollTop" @scroll="scroll" scroll-y @scrolltolower="loadMore(good.cid)">
							 ...
							 :duration="duration">
								<swiper-item v-for="(banner, index) in banners" :key="index">
									<view class="banner-swiper-item">
										<image :src="banner.image" lazy-load mode="aspectFill" @click="bannerClick(banner)" />
									</view>
								</swiper-item>
							</swiper>
						</uni-swiper-dot>
						<view class="grid-list">
							<uni-grid :options="activitys" :show-border="false" columnNum="4" @click="actClick"></uni-grid>
						</view>
						<view class="active-title-image">
							<image :src="index_1.image" lazy-load mode="aspectFill" @click="bannerClick(index_1)"></image>
						</view>
					</view>
